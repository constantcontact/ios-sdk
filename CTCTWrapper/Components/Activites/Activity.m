...
- (id) proxyForJson
{
    ...
    [dict setObject:_activityId forKey:@"id"];
    [dict setObject:_type forKey:@"type"];
    [dict setObject:_status forKey:@"status"];
    [dict setObject:_startDate forKey:@"start_date"];
    [dict setObject:_finishDate forKey:@"finish_date"];
    [dict setObject:_createdDate forKey:@"created_date"];
    [dict setObject:_errorCount forKey:@"error_count"];
    [dict setObject:_contactCount forKey:@"contact_count"];
